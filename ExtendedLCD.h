...
class ExtendedLCD: public LiquidCrystal
{
  public:
		...
		void linePrint_P(const char line1[], const char line2[]);
		void linePrint(const char* value, uint8_t line);
		void linePrint_P(const char* value, uint8_t line);
		void linePrint(const char* l);
		void linePrint_P(const char* l);
		void splash(const char line1[], const char line2[], unsigned long time);
		void splash_P(const char line1[], const char line2[], unsigned long time);
		void splash(const char value[], uint8_t line, unsigned long time);
		void splash_P(const char value[], uint8_t line, unsigned long time);
		void setDisplay(const char line1[], const char line2[]);
		void setDisplay_P(const char line1[], const char line2[]);
		void setDisplay(const char value[], uint8_t line);
		void setDisplay_P(const char value[], uint8_t line);
	private:
